        ...
        <div className="mx-auto max-w-4xl px-5 py-16">
            ...
            <div className="mt-10 grid md:grid-cols-[1fr_1.3fr] gap-8">
                <div className="space-y-4">
                    <div className="docket p-5 flex items-start gap-3 rounded-lg border border-transparent dark:border-ink-800 dark:bg-ink-900/50">
                        <Mail className="h-5 w-5 text-rust-600 dark:text-rust-400 shrink-0 mt-0.5" />
                        <div>
                            <p className="text-sm font-medium text-ink-900 dark:text-white">Email</p>
                            <p className="text-sm text-ink-500 dark:text-ink-400">sayhemrahman@gmail.com</p>
                        </div>
                    </div>

                    <div className="docket p-5 flex items-start gap-3 rounded-lg border border-transparent dark:border-ink-800 dark:bg-ink-900/50">
                        <Phone className="h-5 w-5 text-rust-600 dark:text-rust-400 shrink-0 mt-0.5" />
                        <div>
                            <p className="text-sm font-medium text-ink-900 dark:text-white">Phone</p>
                            <p className="text-sm text-ink-500 dark:text-ink-400">+880 1871-414746</p>
                        </div>
                    </div>

                    <div className="docket p-5 flex items-start gap-3 rounded-lg border border-transparent dark:border-ink-800 dark:bg-ink-900/50">
                        <MapPin className="h-5 w-5 text-rust-600 dark:text-rust-400 shrink-0 mt-0.5" />
                        <div>
