        ...
        <form action="/services" method="GET" className="docket p-5 space-y-5 lg:sticky lg:top-24">
            ...
            <div>
                ...
                >
                    ...
                    <option value="rating-desc">Highest rated technician</option>
                </select>
            </div>
            ...
            {(searchParams?.searchTerm || searchParams?.categoryId || searchParams?.location || searchParams?.minPrice) && (
                <Link href="/services"
                    className="block text-center text-xs text-ink-500 dark:text-ink-400 hover:text-rust-600 font-mono uppercase tracking-wide">
                    Clear all
                </Link>
            )}
        </form>
