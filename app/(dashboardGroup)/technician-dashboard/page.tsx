...
async function getDashboardData() {
    ...
    const technicianId = me?.technicianProfile?.id;
    const detailRes = technicianId
        ? await fetch(`${API_URL}/technicians/single/${technicianId}`, { cache: 'no-store' }).then(r => r.json())
        : { data: null };
...
export default async function TechnicianDashboardPage() {
    ...
    return (
        <div className="mx-auto max-w-5xl px-5 py-12">
            <Badge variant="warning">Technician dashboard</Badge>
            <h1 className="mt-4 font-display text-3xl font-bold text-ink-950 dark:text-white">Manage your workshop</h1>
            ...
            <div className="mt-4 grid gap-4 md:grid-cols-2">
                ...
                <BookingStatusChart
                    ...
                    subtitle="From payments on your own bookings."
                    emptyMessage="No payments yet — this fills in once a customer pays you for an accepted job."
                    barColor="#2F6E5E"
                />
            </div>
