...
//             <h1 className="mt-4 font-display text-3xl font-bold text-ink-950 dark:text-ink-200">Welcome back</h1>

//             <p className="mt-2 text-ink-500 text-sm dark:text-ink-200">Sign in to track your bookings and jobs.</p>
...
export default function LoginForm() {
    ...
    return (
        <div className="mx-auto max-w-md px-5 py-20 text-foreground">
            ...
            <p className="mt-2 text-sm text-muted-foreground">Sign in to track your bookings and jobs.</p>
            ...
            <div className="my-6 flex items-center gap-3">
                <span className="h-px flex-1 bg-ink-100 dark:bg-ink-800" />
                <span className="text-xs font-mono uppercase text-muted-foreground">or sign in manually</span>
                <span className="h-px flex-1 bg-ink-100 dark:bg-ink-800" />
            </div>
            ...
            <p className="mt-6 text-sm text-muted-foreground text-center">
                ...
                <Link
                    href="/register"
                    className="text-rust-600 dark:text-rust-400 font-medium hover:text-rust-700 dark:hover:text-rust-300 transition-colors"
                >
                    Create an account
                </Link>
            </p>
